...
#define rdma_error(msg, args...) do {\
	printf("%s : %d : ERROR : " msg, __FILE__, __LINE__, ## args);\
}while(0);
...
/* TOTALSIZE 2^19 = 524288 2^20 = 1048576 2^21 = 2097152 */
#define TOTALSIZE (524288*2*2)
/* BUFFSIZE*/
#define BUFFSIZE (TOTALSIZE/2)
...
struct ibv_mr* rdma_buffer_alloc_gpu_adress(struct ibv_pd *pd,
		void* addr, 
		uint32_t length, 
		enum ibv_access_flags permission);
